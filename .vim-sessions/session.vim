...
silent only
silent tabonly
cd /private/var/www/html/coding/PERSONAL/vhm-tools/notification-service
...
badd +57 .env
badd +1 src/environments/index.ts
badd +7 src/modules/sendgrid/sendgrid.service.ts
badd +1 src/modules/sendgrid/sendgrid.module.ts
badd +1 src/modules/index.ts
badd +1 src/main.module.ts
badd +11 src/main.ts
badd +1 src/modules/mail/mail.module.ts
badd +1 src/modules/mail/mail.controller.ts
badd +1 libs/infra-common/guards/auth-call.guard.ts
badd +17 src/modules/mail/mail.service.ts
badd +1 libs/infra-common/configs/rabbitmq/index.ts
badd +3 .gitmodules
badd +1 libs/infra-modules/rabbitmq/rabbitmq.module.ts
badd +1 libs/infra-modules/rabbitmq/types/async-option.ts
badd +1 Dockerfile
...
normal! 048|
tabnext
edit src/environments/index.ts
...
silent! normal! zE
let &fdl = &fdl
let s:l = 71 - ((10 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 71
...
silent! normal! zE
let &fdl = &fdl
let s:l = 30 - ((7 * winheight(0) + 22) / 44)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 30
